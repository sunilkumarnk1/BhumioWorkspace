...
public class BasePage {
    ...
    public WebElement waitAndFindElement(WebElement element, int waittime) {
        return new WebDriverWait(this.driver, Duration.ofMillis(waittime)).pollingEvery(Duration.ofMillis(BhumioConstants.SHORT_WAIT))
    ...
    public void waitAndSwitchToFrame(String frameName, int waittime){
        new WebDriverWait(this.driver,Duration.ofMillis(waittime)).pollingEvery(Duration.ofMillis(BhumioConstants.SHORT_WAIT))
